...
function groupAnimals(animals) {
  ...
  /*.log('Hewan A : ' +animalA);
  console.log('Hewan C : ' +animalC);
  console.log('Hewan K : ' +animalK);
  console.log('Hewan U : ' +animalU);*/
  tampungAnimal[0] = animalA;
  tampungAnimal[1] = animalC;
  tampungAnimal[2] = animalK;
  tampungAnimal[3] = animalU;
  //console.log(tampungAnimal);
  return tampungAnimal;
}
